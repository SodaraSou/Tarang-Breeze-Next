...
export const metadata = {
  ...
  description:
    "Join Tarang to find a Volleyball team to play with or compete against. Discover venues to book for your matches and immerse yourself in the world of Volleyball.",
};
